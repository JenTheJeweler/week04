...
let drink = 'tea'
const lunch = 'rigatoni wit sauce'
let myName = 'Jennifer'
let myFriendsName = 'Jade'
console.log(drink, lunch, myName, myFriendsName)

//Question: Name a reason why you would use const instead of let.
//Answer:Const is for when you want to keep the variable the same throughout the life of the code. No one should be able to change it.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`My Friend ${myFriendsName} & ${myName} are eating ${lunch} and drinking ${drink}`)
...
//Answer:  You can't reassign a variable that has been declared with a const declaration. It has to be Let or Var, because they can be reassigned.
...
console.log(foodForTodayAndTomorrow('Rigatoni', 'Tea', lunchTime('Spaghetti', 'Malbec') ))
